...
class LocalizedEventFormatTest {
    ...
    fun `english locale renders the english time and datetime formats`() {
        ...
        composeTestRule.onNodeWithText("Aug 18, 16:58").assertExists()
        composeTestRule.onNodeWithText("Aug 18, 2026 16:58:13").assertExists()
    }
    ...
    fun `pt-br locale renders the portuguese time and datetime formats`() {
        ...
        composeTestRule.onNodeWithText("18 de ago., 16:58").assertExists()
        composeTestRule.onNodeWithText("18 de ago. de 2026, 16:58:13").assertExists()
    }
}

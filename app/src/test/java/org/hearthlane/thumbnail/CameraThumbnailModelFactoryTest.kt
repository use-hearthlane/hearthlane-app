...
class CameraThumbnailModelFactoryTest {
    ...
    fun `create uses the transport from the current connection`() {
        ...
        assertTrue(snapshot.getter is org.hearthlane.core.frigate.TsnetHttpBytesGetter)
    }
    ...
    fun `eventThumbnail respects the current transport getter`() {
        ...
        assertTrue((model as FrigateSnapshot).getter is org.hearthlane.core.frigate.TsnetHttpBytesGetter)

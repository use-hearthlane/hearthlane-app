...
import com.homelab.poc.core.frigate.HttpUrlConnectionStreamGetter
...
class StreamingHttpDataSourceLocalTest {
    ...
    private class NoGateway : com.homelab.poc.core.frigate.TsnetGateway {
        ...
        override suspend fun httpGetBytes(
            url: String,
            timeoutMs: Long,
        ): com.homelab.poc.core.connectivity.HttpBytesResult =
            com.homelab.poc.core.connectivity.HttpBytesResult(200, "application/json", url, ByteArray(0))
    }
}
